...
class fightingmood{
	...
	public:
		fightingmood(){
			...
			questions[6]="I do not find it easy to make decisions";
			questions[7]="I do not have a particular sense of meaning and purpose in my life";
		...
		void display(){
		//	cout << emojicpp::emojize(":raised_hand_with_fingers_splayed:") << endl;
		int sml=1;
		char ch=sml;
			cout<<ch<<" Welcome to Fighting mood\n";
			int choice;
			for(int i=0;i<10;i++){
